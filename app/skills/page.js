    ...
    >
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-700">
          ...
          SQL, JavaScript, CSS, Flask, FastAPI, Django
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-700">
          Large Language Models (LLMs), Fine-tuning, Transformers, BERT, GPT,
          GANs, Reinforcement Learning, Prompt Engineering, LangChain, RAG
        </p>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="mt-2 text-gray-700">
          AWS Academy Cloud Practitioner, Azure Fundamentals, Azure Developer,
          EDX CS50
        </p>
      </div>
    </motion.div>
